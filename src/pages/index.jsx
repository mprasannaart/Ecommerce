...
// // This is the main App component that now contains all the logic and rendering.
// export default function Home() {
//   // State for the main hero carousel
...
//       id: 1,
//       images: [
//         '/images/img_rectangle_4362.png',
//         '/images/image_4f55a2.png',
//         '/images/img_rectangle_4362.png',
//       ],
//       title: 'Men Solid Sports Jogger',
//       price: '₹1,243',
//       badge: 'FRESH FIND\'S'
//     },
//     {
//       id: 2,
//       images: [
//         '/images/img_rectangle_4364.png',
//         '/images/img_rectangle_4364_view2.png',
//         '/images/img_rectangle_4364_view3.png',
//       ],
...
//     {
//       id: 9, // Changed ID to avoid conflict with the 'products' array
//       images: [
//         '/images/img_rectangle_4430.png',
//         '/images/img_rectangle_4430_view2.png',
//         '/images/img_rectangle_4430_view3.png',
//       ],
//       title: 'Men Solid Athleisure Shorts',
//       price: '₹500',
//       badge: 'FRESH FIND\'S'
//     },
//     {
//       id: 10,
//       images: [
//         '/images/img_rectangle_4431.png',
//         '/images/img_rectangle_4431_view2.png',
//         '/images/img_rectangle_4431_view3.png',
//       ],
//       title: 'Men Graphic Print T-shirt',
//       price: '₹649',
//       badge: 'FRESH FIND\'S'
...
//   // Auto-slide effect for the main carousel
//   useEffect(() => {
...
//   // Scroll effect for Hand to Hand section
...
//   // Functions for the main hero carousel
//   const goToNext = () => {
//     setCurrentSlide((prev) => (prev + 1) % totalSlides);
//   };
...
//   // Functions to handle the product image carousel on hover
...
//   /**
//    * This function changes the displayed image for a product.
//    * It takes the product's ID and a direction (-1 for previous, 1 for next)
//    * It updates the productImageIndex state to show the next or previous image in the array.
//    * The new index wraps around, so it goes from the last image back to the first.
//    */
//   const changeImage = (productId, direction) => {
//     setProductImageIndex(prev => {
//       const allProducts = [...products, ...popularProducts];
//       const currentImages = (allProducts.find(p => p.id === productId))?.images;
...
//       {/* Top Black Bar */}
//       <div className="w-full bg-global-1 h-[20px] sm:h-[30px] lg:h-[40px]"></div>
      
//       {/* Header - Assuming Header is a custom component */}
//       {/* <Header /> */}
...
//                   {/* SHOP NOW Button */}
//                   <div
//                     className="absolute bottom-[80px] sm:bottom-[100px] lg:bottom-[120px] left-4 sm:left-6 lg:left-[160px] bg-gray-800 text-white font-['Azeret_Mono'] text-[10px] sm:text-[12px] font-normal leading-[12px] sm:leading-[15px] px-[6px] sm:px-[8px] py-[6px] sm:py-[8px] rounded-[5px] w-fit cursor-pointer"
//                   >
//                     SHOP NOW
//                   </div>
                  
//                   {/* Main Carousel Arrow Buttons */}
...
//                     <button
//                       onClick={goToPrev}
//                       className="bg-global-3 p-[10px] sm:p-[14px] rounded-full hover:bg-gray-100 transition-colors"
//                     >
...
//             <img src="/images/img_rectangle_4351.png" alt="New Arrival" className="w-full h-[200px] sm:h-[300px] lg:h-[466px] object-cover" />
//             <img src="/images/img_rectangle_4357.png" alt="T-Shirts" className="w-full h-[200px] sm:h-[300px] lg:h-[466px] object-cover" />
//             <img src="/images/img_rectangle_4353.png" alt="Tracks" className="w-full h-[200px] sm:h-[300px] lg:h-[466px] object-cover" />
//             <img src="/images/img_rectangle_4358.png" alt="Shorts" className="w-full h-[200px] sm:h-[300px] lg:h-[466px] object-cover" />
//           </div>
...
//                     ? 'bg-global-1 text-global-2' : 'bg-global-3 text-global-1 hover:bg-gray-100'
//                 }`}
//               >
//                 {category}
//               </button>
...
//                       {/* Left Arrow Button */}
//                       <button
//                         onClick={(e) => { e.stopPropagation(); changeImage(product.id, -1); }}
//                         className="p-2 w-[200px] h-[35px] flex items-center justify-center bg-white text-black border border-gray-300 shadow-md transition-shadow hover:shadow-lg hover:bg-black hover:text-white"
//                       >
...
//                     <span className="bg-global-4 text-global-1 font-['Azeret_Mono'] text-[10px] sm:text-[12px] font-semibold leading-[12px] sm:leading-[15px] lg:leading-[15px] px-2 py-1">
//                       {product?.badge}
//                     </span>
//                     <div className="bg-global-3 p-[2px] rounded">
//                       <img src="/images/img_vector.svg" alt="Favorite" className="w-[10px] h-[10px] sm:w-[12px] sm:h-[12px]" />
//                     </div>
//                   </div>
//                 </div>
...
//       {/* Hand to Hand Section with Sticky Background and Bottom-to-Top Animation */}
//       <section
//         id="hand-to-hand-section"
//         ref={handRef}
//         className="relative w-full"
//         style={{ height: `calc(1vh + ${SCROLL_LEN_VH}vh)` }} 
//       >
...
//                 At FOXO, we believe style and comfort should go hand in hand. Our mission is to create premium-quality apparel that makes you feel confident, whether you are at the gym, out on the streets, or simply relaxing at home.
//               </p>
//               <p className="text-global-2 font-['Manrope'] text-[14px] sm:text-[17px] lg:text-[20px] leading-[21px] sm:leading-[26px] lg:leading-[30px] text-justify">
//                 Founded with a passion for fashion and functionality, we craft each product using high-grade fabrics and cutting-edge designs. From classic round-neck T-shirts to performance-ready track pants, every piece is thoughtfully made to last, keeping you comfortable and stylish in every moment.
//               </p>
//               <p className="text-global-2 font-['Manrope'] text-[14px] sm:text-[17px] lg:text-[20px] leading-[21px] sm:leading-[26px] lg:leading-[30px] text-justify">
//                 We take pride in delivering exceptional value to our customers. With a strong focus on quality, sustainability, and customer satisfaction, FOXO has grown into a trusted name in modern lifestyle apparel.
//               </p>
//             </div>
//           </div>
//         </div>
...
//                         <div
//                           key={btnText}
//                           className="bg-white text-black font-['Azeret_Mono'] text-[10px] sm:text-[11px] lg:text-[12px] font-medium px-3 py-2 rounded-md shadow-sm hover:bg-gray-100 transition-colors cursor-pointer"
//                         >
//                           {btnText}
//                         </div>
//                       ))}
...
//                         />
//                         {/* Popular Products Carousel Arrow Buttons (Box Style) */}
//                         {hoveredProduct === product.id && (
//                           <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-6">
//                             {/* Left Arrow Button */}
//                             <button
...
//       {/* Footer - Assuming Footer is a custom component */}
//       {/* <Footer /> */}
//     </div>
//   );
// };
